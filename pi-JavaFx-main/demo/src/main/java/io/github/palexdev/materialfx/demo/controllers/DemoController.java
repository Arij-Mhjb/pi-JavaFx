...
public class DemoController implements Initializable {
	...
	private void initializeLoader() {
		...
		loader.addView(MFXLoaderBean.of("Matches", loadURL("fxml/Buttons.fxml")).setBeanToNodeMapper(() -> createToggle("fas-circle-dot", "Matches")).setDefaultRoot(true).get());
		loader.addView(MFXLoaderBean.of("Products", loadURL("fxml/Products.fxml")).setBeanToNodeMapper(() -> createToggle("fas-circle-dot", "Products")).setDefaultRoot(true).get());
